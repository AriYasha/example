					...
					<div class="row top-bar-holder">
						...
						<div class="col-xs-3 col justify-end">
							...
							<ul class="list-unstyled user-links fw-bold font-lato">
								<li><a href="index.jsp" class="lightbox">Login</a> <span class="sep">|</span> <a href="index.jsp" class="lightbox">Register</a></li>
							</ul>
							 <c:out value="${user}"/> в системе
						</div>
					</div>
				</div>
			</div>
